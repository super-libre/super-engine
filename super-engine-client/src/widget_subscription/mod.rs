...
use crate::http_client::{self, WidgetEvent};
use crate::session::{self, AppId};
...
#[must_use]
pub fn is_user_denied(err: &crate::http_client::HttpError) -> bool {
    matches!(err, crate::http_client::HttpError::AuthDenied { reason } if is_user_denied_reason(reason))
}
