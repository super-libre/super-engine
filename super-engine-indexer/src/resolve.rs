...
fn parse_semver(s: &str) -> Result<Version, String> {
    ...
    super_engine_spec::version::parse_version(s).ok_or_else(|| s.to_string())
}
...
mod tests {
    ...
    fn entry(prefix: Option<&str>, max: Option<&str>) -> Entry {
        Entry {
            ...
            forge: super_engine_spec::forge::Forge::Github,
            subdir: None,
    ...
    fn filters_by_tag_prefix() {
        let r = select_release(
            vec![rel("openai-1.0.0"), rel("other-2.0.0"), rel("openai-1.5.0")],
